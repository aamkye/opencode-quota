...
- [x] 2.4 Convert quota, home, and token-report to standalone modules with normalized manifest IDs.
- [x] 2.5 Verify quota and home share one provider hub when both are active and remain functional when installed alone.
