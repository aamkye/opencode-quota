...
concept_id: tui/services/subagent-snapshot/abortReason
language: typescript
---
...
## Source
Lines 52–54 in `tui/services/subagent-snapshot.ts`
...
| called_by | [abort](/tui/services/subagent-snapshot/abort.md) |
...
| called_by | [throwIfAborted](/tui/services/subagent-snapshot/throwIfAborted.md) |
