...
concept_id: tests/subagent-mounted/resolveMessages
language: typescript
---
...
```typescript
resolveMessages(sessionID: string, result: ClientResult<readonly { info: unknown }[]>)
```

## Source
Lines 644–650 in `tests/subagent-mounted.fixture.ts`
...
| called_by | [resolveReady](/tests/subagent-mounted/resolveReady.md) |
