...
concept_id: tests/provider-openai/adapterApi
language: javascript
---
...
## Source
Lines 76–85 in `tests/provider-openai.test.mjs`
...
| called_by | [createTestAdapter](/tests/provider-openai/createTestAdapter.md) |
