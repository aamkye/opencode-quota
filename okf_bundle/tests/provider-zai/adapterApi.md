...
concept_id: tests/provider-zai/adapterApi
language: javascript
---
...
## Source
Lines 124–134 in `tests/provider-zai.test.mjs`
...
| called_by | [createTestAdapter](/tests/provider-zai/createTestAdapter.md) |
