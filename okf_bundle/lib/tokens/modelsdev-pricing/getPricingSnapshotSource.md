...
okf_version: "0.2"
type: Function
title: getPricingSnapshotSource
...
concept_id: lib/tokens/modelsdev-pricing/getPricingSnapshotSource
language: typescript
---
...
```typescript
function getPricingSnapshotSource(): "runtime" | "bundled" | "empty"
```

## Source
Lines 690–693 in `lib/tokens/modelsdev-pricing.ts`
