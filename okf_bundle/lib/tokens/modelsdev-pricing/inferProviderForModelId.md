...
concept_id: lib/tokens/modelsdev-pricing/inferProviderForModelId
language: typescript
---
...
```typescript
function inferProviderForModelId(modelId: string): string | null
```

## Source
Lines 725–729 in `lib/tokens/modelsdev-pricing.ts`
