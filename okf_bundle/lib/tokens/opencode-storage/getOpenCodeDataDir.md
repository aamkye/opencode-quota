...
concept_id: lib/tokens/opencode-storage/getOpenCodeDataDir
language: typescript
---
...
## Source
Lines 60–62 in `lib/tokens/opencode-storage.ts`
...
| calls | [getOpenCodeDataDirCandidates](/lib/tokens/opencode-storage/getOpenCodeDataDirCandidates.md) |
