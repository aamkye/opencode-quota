...
concept_id: lib/tokens/cursor-pricing/isCursorProviderId
language: typescript
---
...
```typescript
function isCursorProviderId(raw?: string): boolean
```

## Source
Lines 102–105 in `lib/tokens/cursor-pricing.ts`
